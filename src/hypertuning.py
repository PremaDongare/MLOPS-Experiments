...
import dagshub
dagshub.init(repo_owner='PremaDongare', repo_name='MLOPS-Experiments', mlflow=True)

# set tracking uri

mlflow.set_tracking_uri("https://dagshub.com/PremaDongare/MLOPS-Experiments.mlflow")
...
with mlflow.start_run() as parent:
    ...
    # Set tags
    mlflow.set_tag("author", "Prema Dongare")
